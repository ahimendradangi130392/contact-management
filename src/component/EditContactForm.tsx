            ...
            <div className="w-[100%] h-[100%] rounded-md border-solid border-4 border-[#2fa0cc]  drop-shadow-md ..." >
                ...
                <div className='flex'>
                    ...
                    <div className="ml-[13px]">
                        <p className="font-semibold font-serif text-lg text-gray-800 text-center mt-[2rem] mb-[-1rem]">Edit contact screen</p>
...
export default EdditContactForm;